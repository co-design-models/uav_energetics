...
types = {
    ...
    "LiPo": dict(
        desc="Lithium polimer", specific_energy="250 Wh/kg", specific_cost="2.50 Wh/$", cycles="600"
    ),
    "LMO": dict(
    ...
    "NiCad": dict(desc="Nickel-cadmium", specific_energy="30 Wh/kg", specific_cost="7.50 Wh/$", cycles="500"),
