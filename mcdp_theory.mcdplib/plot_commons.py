...
def figure_num_implementations2(r, data, cs, fname1, fname2):
    ...
    with r.plot("feasibility", **fig) as pylab:
        ...
        pylab.plot(f1[cs.one_solution], f2[cs.one_solution], "k.", markersize=4, **popt)
        pylab.plot(f1[cs.multiple_solutions], f2[cs.multiple_solutions], "ms", markersize=4, **popt)
        pylab.plot(f1[cs.is_not_feasible], f2[cs.is_not_feasible], "r.", markersize=0.5, **popt)
    ...
    with r.plot("implementations", **fig) as pylab:
        ...
        pylab.plot(f1[cs.one_implementation], f2[cs.one_implementation], "k.", markersize=4, **popt)
        pylab.plot(
            f1[cs.multiple_implementations], f2[cs.multiple_implementations], "ms", markersize=4, **popt
        )
        pylab.plot(f1[cs.is_not_feasible], f2[cs.is_not_feasible], "r.", markersize=0.5, **popt)
